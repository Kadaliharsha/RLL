...
def doctor_menu():
    while True:
        ...
        print("4. Edit Doctor Record")
        print("5. Remove Doctor Record")
...
def appointment_menu():
    while True:
        ...
        print("3. Update Appointment Details")
        ...
        if choice == '1':
            ...
            appointment = Appointment(appt_id, patient_id, doctor_id, date, diagnosis)
            ...
            Appointment(appt_id, patient_id, doctor_id, date, diagnosis).update()
